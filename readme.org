...
;; Don't show warnings about obsolete functions during package loading (setq warning-minimum-level :error)
...
(use-package evil
  ...
  ;; Buffer nav to h and l
  (evil-define-key '(normal insert visual) 'global (kbd "C-S-h") 'switch-to-prev-buffer)
  (evil-define-key '(normal insert visual) 'global (kbd "C-S-l") 'switch-to-next-buffer)
