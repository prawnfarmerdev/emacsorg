...
#+begin_src emacs-lisp
;; Configure Evil settings BEFORE loading Evil
(setq evil-want-integration t
      evil-want-keybinding nil
      evil-want-C-u-scroll t        ; Use C-u for scrolling up
      evil-undo-system 'undo-tree)  ; Set undo system before Evil loads
...
(use-package corfu
  ...
  (define-key global-map (kbd "M-/") #'completion-at-point)

  ;; Corfu navigation keys
...
(use-package eglot
  ...
  :commands (eglot eglot-ensure)  ; Load eglot only when called
  :config
