...
;; Reverse layout (prompt bottom), indexed candidates, auto-sizing

(defun dw/minibuffer-backward-kill (arg)
  "Delete to parent directory in file paths, else delete backward."
  (interactive "p")
...
(use-package vertico
  ...
  (setq vertico-cycle t
        vertico-count 10        ; Max candidates to show
        vertico-resize t)       ; Auto-resize to fit actual count
