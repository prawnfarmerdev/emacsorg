...
(use-package dape
  ...
  ;; Use default directory as working directory (can customize later)
  ;; If you install projectile, you can use: (setq dape-cwd-fn 'projectile-project-root)
  (setq dape-cwd-fn 'dape-cwd-default)
...
;; Example dape configurations for common languages:
