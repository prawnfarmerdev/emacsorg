...
;; Set font
(set-face-attribute 'default nil :font "CaskaydiaCove Nerd Font" :height 250)
#+end_src
...
;; Make consult searches work in dired
(with-eval-after-load 'dired
  (define-key dired-mode-map (kbd "M-s f") 'consult-find)
  (define-key dired-mode-map (kbd "M-s g") 'consult-ripgrep)
  (define-key dired-mode-map (kbd "M-s l") 'consult-line))
#+end_src
