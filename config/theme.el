...
;; Expose cursor colors as defvars so they can be referenced outside the let* block
...
(let* ((almost-white       "#cccccc")     ; Default text
       ...
       (mode-line-background-active menudo-gold)
  ...
  (custom-theme-set-faces
   ...
   `(cursor            ((t (:background ,solarized-yellow))))
   ...
   ;;==========================================================================
   `(vertico-current            ((t (:background ,bellpepper-green :foreground ,almost-white))))
   ...
   `(org-level-2 ((t (:foreground ,coffee-brown :weight bold :height 1.2))))
   `(org-level-3 ((t (:foreground ,bright-red :weight bold :height 1.1))))
   ...
   `(org-modern-done       ((t (:background ,charcoal-gray-lite :foreground ,coffee-brown :weight bold))))
